  ...
  <div>
    <div class="modal-content">
      <div class="modal-card-head">
        <p class="modal-card-title has-text-centered" v-if="!this.player.account">Add Player</p>
        <p class="modal-card-title has-text-centered" v-else>Confirm League of Legends Account</p>
      </div>
                  ...
                  <div class="columns">
                    <div class="column">
                        <b-field  label="Account Name">
                            <b-input placeholder="BOOTYWIZARD42069" required icon="gamepad" v-model="player.summonerName"></b-input>
                        </b-field>
                        <b-field  label="Player Name">
                            <b-input placeholder="An Easier Name to Pronounce" required icon="account-circle" v-model="player.name"></b-input>
                        </b-field>
                        <b-field  label="Notes">
            ...
            <div class="level-item">
              <figure class="image is-128x128">
                <img class="is-rounded"
                  v-bind:src="'http://ddragon.leagueoflegends.com/cdn/9.8.1/img/profileicon/' + this.player.account.profileIconId +'.png'"
                  alt="Summoner Icon">
              </figure>
            </div>
          </nav>
          <div class="card-content">
            <div class="media">
              <div class="media-content">
                ...
                <p class="subtitle is-6 has-text-centered">{{player.account.summonerLevel}}</p>
              </div>
            </div>
          </div>
          <footer>
